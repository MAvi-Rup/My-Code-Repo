...
100 = Bypass mode. Do not use Delivery Optimization and use BITS instead.</string>
...
The value 0 means "not-limited"; The cloud service set default value will be used.</string>
      ...
      <string id="CacheHost_Help">This policy allows you to set one or more Delivery Optimization in Network Cache servers that will be used by your client(s).
...
One or more values can be added as either fully qualified domain names (FQDN) or IP addresses. To add multiple values, separate each FQDN or IP address by commas.
      ...
      <string id="CacheHostSource_Help">This policy allows you to specify how your client(s) can discover Delivery Optimization in Network Cache servers dynamically.
...
For both options, the client will query DHCP Option ID 235 and use the returned value as the Cache Server Hostname. Option 2 overrides the Cache Server Hostname policy, if configured.</string>
...
Option 1 (Subnet mask) applies to both Download Mode LAN (1) and Group (2).</string>
      <string id="RestrictPeerSelectionBy_None">None</string>
    ...
    <presentationTable>
      ...
      <presentation id="RestrictPeerSelectionBy">
        <dropdownList defaultItem="0" noSort="true" refId="RestrictPeerSelectionBy">Restrict Peer Selection By:</dropdownList>
      </presentation>
      ...
      <presentation id="SetHoursToLimitForegroundDownloadBandwidth">
        ...
        <decimalTextBox defaultValue="0" refId="SetH